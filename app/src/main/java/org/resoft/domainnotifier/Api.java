...
public class Api {
    ...
    public void post(String api_url, final JSONObject params, final GeneralCallbacks callback){
        final JsonObjectRequest request_json = new JsonObjectRequest(Request.Method.POST,api_url,params,
    ...
    public void postString(String api_url, final HashMap<String, String> params, final GeneralCallbacks callback){
